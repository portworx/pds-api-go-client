...
Adds role binding to existing user. The plan is to send invites to non-existing users in the future.
 ...
 @param id2 Account ID (must be valid UUID)
 @return ApiApiAccountsIdInvitationsPostRequest
*/
func (a *AccountRoleBindingsApiService) ApiAccountsIdInvitationsPost(ctx _context.Context, id string, id2 interface{}) ApiApiAccountsIdInvitationsPostRequest {
	return ApiApiAccountsIdInvitationsPostRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *AccountRoleBindingsApiService) ApiAccountsIdRoleBindingsGet(ctx _context.Context, id interface{}, id2 string) ApiApiAccountsIdRoleBindingsGetRequest {
	return ApiApiAccountsIdRoleBindingsGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
/*
ApiAccountsIdRoleBindingsPut Create AccountRoleBinding

Creates a new AccountRoleBinding
