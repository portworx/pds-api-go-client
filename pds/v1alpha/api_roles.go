...
func (r ApiApiRolesGetRequest) Execute() (ControllersPaginatedRoles, *_nethttp.Response, error) {
	return r.ApiService.ApiRolesGetExecute(r)
}

/*
ApiRolesGet List Roles
...
*/
func (a *RolesApiService) ApiRolesGet(ctx _context.Context) ApiApiRolesGetRequest {
	return ApiApiRolesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RolesApiService) ApiRolesGetExecute(r ApiApiRolesGetRequest) (ControllersPaginatedRoles, *_nethttp.Response, error) {
	var (
