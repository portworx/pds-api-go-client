...
*BackupTargetsApi* | [**ApiBackupTargetsPost**](docs/BackupTargetsApi.md#apibackuptargetspost) | **Post** /api/backup-targets | Create BackupTarget
...
*BackupsApi* | [**ApiBackupsPost**](docs/BackupsApi.md#apibackupspost) | **Post** /api/backups | Create Backup
...
*DeploymentTargetsApi* | [**ApiDeploymentTargetsPost**](docs/DeploymentTargetsApi.md#apideploymenttargetspost) | **Post** /api/deployment-targets | Create DeploymentTarget
...
*NamespacesApi* | [**ApiNamespacesPost**](docs/NamespacesApi.md#apinamespacespost) | **Post** /api/namespaces | Create Namespace
...
## Documentation For Models
 ...
 - [ControllersCreateBackupRequest](docs/ControllersCreateBackupRequest.md)
 - [ControllersCreateBackupTargetRequest](docs/ControllersCreateBackupTargetRequest.md)
 - [ControllersCreateDeploymentBackup](docs/ControllersCreateDeploymentBackup.md)
 - [ControllersCreateDeploymentRequest](docs/ControllersCreateDeploymentRequest.md)
 - [ControllersCreateDeploymentTargetRequest](docs/ControllersCreateDeploymentTargetRequest.md)
 - [ControllersCreateNamespace](docs/ControllersCreateNamespace.md)
 - [ControllersCreateNamespaceRequest](docs/ControllersCreateNamespaceRequest.md)
