...
// A given Accounts attribute to sort results by (one of: id, name)
...
func (r ApiApiAccountsGetRequest) ActorId(actorId string) ApiApiAccountsGetRequest {
	r.actorId = &actorId
	return r
}
...
// A given User attribute to sort results by (one of: id, email)
...
func (r ApiApiAccountsIdUsersGetRequest) Id(id string) ApiApiAccountsIdUsersGetRequest {
	r.id = &id
	return r
}
...
*/
func (a *AccountsApiService) ApiAccountsIdUsersGet(ctx _context.Context) ApiApiAccountsIdUsersGetRequest {
	return ApiApiAccountsIdUsersGetRequest{
		ApiService: a,
		ctx: ctx,
	}
