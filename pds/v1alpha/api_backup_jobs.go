...
// A given BackupJob attribute to sort results by (one of: id, file_size, start_time, completion_time, state)
...
func (r ApiApiBackupsIdJobsGetRequest) Execute() (ControllersPaginatedBackupJobs, *_nethttp.Response, error) {
...
func (a *BackupJobsApiService) ApiBackupsIdJobsGetExecute(r ApiApiBackupsIdJobsGetRequest) (ControllersPaginatedBackupJobs, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
