...
type ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest struct {
	ctx context.Context
	ApiService *ProjectRoleBindingsApiService
	id string
	tenantid string
...
// A given ProjectRoleBinding attribute to sort results by (allowed: role_name)
func (r ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest) SortBy(sortBy string) ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest {
	r.sortBy = &sortBy
	return r
}
// Filter results by role_name
func (r ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest) RoleName(roleName string) ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest {
	r.roleName = &roleName
	return r
}

func (r ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest) Execute() (*ControllersPaginatedProjectRoleBindings, *http.Response, error) {
	return r.ApiService.ApiUsersIdTenantsTenantidProjectRoleBindingsGetExecute(r)
}

/*
ApiUsersIdTenantsTenantidProjectRoleBindingsGet List User's ProjectRoleBindings

Lists the ProjectRoleBindings of a User for a specific Tenant.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id User ID (must be valid UUID)
 @param tenantid Tenant ID (must be valid UUID)
 @return ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest
*/
func (a *ProjectRoleBindingsApiService) ApiUsersIdTenantsTenantidProjectRoleBindingsGet(ctx context.Context, id string, tenantid string) ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest {
	return ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ControllersPaginatedProjectRoleBindings
func (a *ProjectRoleBindingsApiService) ApiUsersIdTenantsTenantidProjectRoleBindingsGetExecute(r ApiApiUsersIdTenantsTenantidProjectRoleBindingsGetRequest) (*ControllersPaginatedProjectRoleBindings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectRoleBindingsApiService.ApiUsersIdTenantsTenantidProjectRoleBindingsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/users/{id}/tenants/{tenantid}/project-role-bindings"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
