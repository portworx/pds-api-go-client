...
**DeploymentManifest** | Pointer to [**ModelsDeploymentManifest**](ModelsDeploymentManifest.md) |  | [optional] 
**DeploymentTarget** | Pointer to [**ModelsDeploymentTarget**](ModelsDeploymentTarget.md) |  | [optional] 
...
**DnsZone** | Pointer to **string** | DNSZone domain which this deployment should be a part of (eg pds-dns.io). | [optional] 
...
**Namespace** | Pointer to [**ModelsNamespace**](ModelsNamespace.md) |  | [optional] 
...
**TlsEnabled** | Pointer to **bool** | Whether Transport Layer Security support is enabled | [optional] 
**TlsIssuer** | Pointer to **string** | The Issuer (~Certificate Authority) for the TLS certificates | [optional] 
