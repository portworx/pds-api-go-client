...
// checks if the ModelsGlobalRoleBinding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsGlobalRoleBinding{}
...
func (o ModelsGlobalRoleBinding) ToMap() (map[string]interface{}, error) {
