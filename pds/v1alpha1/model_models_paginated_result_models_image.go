...
// checks if the ModelsPaginatedResultModelsImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsPaginatedResultModelsImage{}
...
func (o ModelsPaginatedResultModelsImage) ToMap() (map[string]interface{}, error) {
