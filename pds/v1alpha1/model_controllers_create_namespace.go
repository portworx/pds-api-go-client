...
// checks if the ControllersCreateNamespace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControllersCreateNamespace{}
...
func (o ControllersCreateNamespace) ToMap() (map[string]interface{}, error) {
