...
*/
func (a *TenantsApiService) ApiProjectsIdPatch(ctx context.Context, id string) ApiApiProjectsIdPatchRequest {
	return ApiApiProjectsIdPatchRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *TenantsApiService) ApiProjectsIdPatchExecute(r ApiApiProjectsIdPatchRequest) (*ModelsProject, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantsApiService.ApiProjectsIdPatch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
