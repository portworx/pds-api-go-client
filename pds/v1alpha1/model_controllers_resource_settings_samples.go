...
// checks if the ControllersResourceSettingsSamples type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControllersResourceSettingsSamples{}
...
func (o ControllersResourceSettingsSamples) ToMap() (map[string]interface{}, error) {
