...
type ApiApiTenantsIdInvitationsPostRequest struct {
	ctx context.Context
	ApiService *TenantRoleBindingsApiService
	id string
	body *RequestsInvitationTenantRequest
}

// Request body containing the invitation details.
func (r ApiApiTenantsIdInvitationsPostRequest) Body(body RequestsInvitationTenantRequest) ApiApiTenantsIdInvitationsPostRequest {
	r.body = &body
	return r
}

func (r ApiApiTenantsIdInvitationsPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.ApiTenantsIdInvitationsPostExecute(r)
}

/*
ApiTenantsIdInvitationsPost Create Tenant Invitation

Adds tenant role binding to existing user.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Tenant ID (must be valid UUID)
 @return ApiApiTenantsIdInvitationsPostRequest
*/
func (a *TenantRoleBindingsApiService) ApiTenantsIdInvitationsPost(ctx context.Context, id string) ApiApiTenantsIdInvitationsPostRequest {
	return ApiApiTenantsIdInvitationsPostRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *TenantRoleBindingsApiService) ApiTenantsIdInvitationsPostExecute(r ApiApiTenantsIdInvitationsPostRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantRoleBindingsApiService.ApiTenantsIdInvitationsPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/tenants/{id}/invitations"
...
type ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest struct {
	ctx context.Context
	ApiService *TenantRoleBindingsApiService
	id string
	accountid string
...
// A given TenantRoleBinding attribute to sort results by (allowed: role_name)
func (r ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest) SortBy(sortBy string) ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest {
	r.sortBy = &sortBy
	return r
}
// Filter results by role_name
func (r ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest) RoleName(roleName string) ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest {
	r.roleName = &roleName
	return r
}

func (r ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest) Execute() (*ControllersPaginatedTenantRoleBindings, *http.Response, error) {
	return r.ApiService.ApiUsersIdAccountsAccountidTenantRoleBindingsGetExecute(r)
}

/*
ApiUsersIdAccountsAccountidTenantRoleBindingsGet List User's TenantRoleBindings

Lists the TenantRoleBindings of a User for a specific Account.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id User ID (must be valid UUID)
 @param accountid Account ID (must be valid UUID)
 @return ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest
*/
func (a *TenantRoleBindingsApiService) ApiUsersIdAccountsAccountidTenantRoleBindingsGet(ctx context.Context, id string, accountid string) ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest {
	return ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ControllersPaginatedTenantRoleBindings
func (a *TenantRoleBindingsApiService) ApiUsersIdAccountsAccountidTenantRoleBindingsGetExecute(r ApiApiUsersIdAccountsAccountidTenantRoleBindingsGetRequest) (*ControllersPaginatedTenantRoleBindings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantRoleBindingsApiService.ApiUsersIdAccountsAccountidTenantRoleBindingsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/users/{id}/accounts/{accountid}/tenant-role-bindings"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
