...
// checks if the ModelsBackup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsBackup{}
...
func (o ModelsBackup) ToMap() (map[string]interface{}, error) {
