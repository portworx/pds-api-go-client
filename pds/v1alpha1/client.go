...
// APIClient manages communication with the PDS API API v1.0.0
...
type APIClient struct {
	...
	BackupCredentialsApi *BackupCredentialsApiService
	...
	ProjectRoleBindingsApi *ProjectRoleBindingsApiService
