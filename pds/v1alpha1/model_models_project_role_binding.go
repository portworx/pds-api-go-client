...
// checks if the ModelsProjectRoleBinding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsProjectRoleBinding{}
...
func (o ModelsProjectRoleBinding) ToMap() (map[string]interface{}, error) {
