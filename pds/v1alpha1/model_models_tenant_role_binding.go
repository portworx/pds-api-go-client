...
// checks if the ModelsTenantRoleBinding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsTenantRoleBinding{}
...
func (o ModelsTenantRoleBinding) ToMap() (map[string]interface{}, error) {
