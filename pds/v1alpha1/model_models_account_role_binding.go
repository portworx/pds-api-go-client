...
// checks if the ModelsAccountRoleBinding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsAccountRoleBinding{}
...
func (o ModelsAccountRoleBinding) ToMap() (map[string]interface{}, error) {
