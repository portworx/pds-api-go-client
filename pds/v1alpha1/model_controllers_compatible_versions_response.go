...
// checks if the ControllersCompatibleVersionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControllersCompatibleVersionsResponse{}
...
func (o ControllersCompatibleVersionsResponse) ToMap() (map[string]interface{}, error) {
