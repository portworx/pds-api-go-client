...
// checks if the ModelsPaginatedResultModelsProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsPaginatedResultModelsProject{}
...
func (o ModelsPaginatedResultModelsProject) ToMap() (map[string]interface{}, error) {
