...
// checks if the ModelsBackupPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsBackupPolicy{}
...
func (o ModelsBackupPolicy) ToMap() (map[string]interface{}, error) {
