...
// checks if the ControllersUpsertTenantRoleBindingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControllersUpsertTenantRoleBindingRequest{}
...
func (o ControllersUpsertTenantRoleBindingRequest) ToMap() (map[string]interface{}, error) {
