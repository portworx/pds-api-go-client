...
// checks if the ModelsPaginatedResultModelsTenant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsPaginatedResultModelsTenant{}
...
func (o ModelsPaginatedResultModelsTenant) ToMap() (map[string]interface{}, error) {
