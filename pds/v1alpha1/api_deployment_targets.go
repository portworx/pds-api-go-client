...
*/
func (a *DeploymentTargetsApiService) ApiDeploymentTargetsIdDeploymentEventsPost(ctx context.Context, id string) ApiApiDeploymentTargetsIdDeploymentEventsPostRequest {
	return ApiApiDeploymentTargetsIdDeploymentEventsPostRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *DeploymentTargetsApiService) ApiDeploymentTargetsIdDeploymentEventsPostExecute(r ApiApiDeploymentTargetsIdDeploymentEventsPostRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeploymentTargetsApiService.ApiDeploymentTargetsIdDeploymentEventsPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
