...
func (r ApiApiTenantsIdBackupCredentialsGetRequest) Id(id string) ApiApiTenantsIdBackupCredentialsGetRequest {
	r.id = &id
	return r
}
...
*/
func (a *BackupCredentialsApiService) ApiTenantsIdBackupCredentialsGet(ctx context.Context) ApiApiTenantsIdBackupCredentialsGetRequest {
	return ApiApiTenantsIdBackupCredentialsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
*/
func (a *BackupCredentialsApiService) ApiTenantsIdBackupCredentialsPost(ctx context.Context) ApiApiTenantsIdBackupCredentialsPostRequest {
	return ApiApiTenantsIdBackupCredentialsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
