...
// checks if the ControllersBackupJobsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControllersBackupJobsResponse{}
...
func (o ControllersBackupJobsResponse) ToMap() (map[string]interface{}, error) {
