...
// checks if the V1DeploymentCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1DeploymentCredentials{}
...
func (o V1DeploymentCredentials) ToMap() (map[string]interface{}, error) {
