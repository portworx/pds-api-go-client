...
// checks if the Deploymentv1Status type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Deploymentv1Status{}
...
func (o *Deploymentv1Status) GetDeploymentTopologyStatus() []V1DeploymentTopologyStatus {
	if o == nil || IsNil(o.DeploymentTopologyStatus) {
...
func (o Deploymentv1Status) ToMap() (map[string]interface{}, error) {
