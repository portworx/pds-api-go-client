...
// checks if the V1ListBackupsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListBackupsResponse{}
...
func (o V1ListBackupsResponse) ToMap() (map[string]interface{}, error) {
