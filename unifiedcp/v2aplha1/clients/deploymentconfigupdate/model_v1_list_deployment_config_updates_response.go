...
// checks if the V1ListDeploymentConfigUpdatesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListDeploymentConfigUpdatesResponse{}
...
func (o *V1ListDeploymentConfigUpdatesResponse) GetDeploymentConfigUpdates() []V1DeploymentConfigUpdate {
	if o == nil || IsNil(o.DeploymentConfigUpdates) {
...
func (o V1ListDeploymentConfigUpdatesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DeploymentConfigUpdates) {
