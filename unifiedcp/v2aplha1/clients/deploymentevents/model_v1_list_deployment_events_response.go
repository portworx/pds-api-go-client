...
// checks if the V1ListDeploymentEventsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListDeploymentEventsResponse{}
...
func (o *V1ListDeploymentEventsResponse) GetDeploymentEvents() []V1DeploymentEvent {
	if o == nil || IsNil(o.DeploymentEvents) {
...
func (o V1ListDeploymentEventsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DeploymentEvents) {
