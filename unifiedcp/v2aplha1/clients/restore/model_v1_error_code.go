...
// List of v1ErrorCode
const (
	ERROR_CODE_UNSPECIFIED V1ErrorCode = "ERROR_CODE_UNSPECIFIED"
	PX_CLOUD_CREDENTIALS_NOT_FOUND V1ErrorCode = "PX_CLOUD_CREDENTIALS_NOT_FOUND"
	PX_CLOUD_SNAP_RESTORE_TRIGGER_FAILED V1ErrorCode = "PX_CLOUD_SNAP_RESTORE_TRIGGER_FAILED"
	PX_CLOUD_SNAP_RESTORE_FAILED V1ErrorCode = "PX_CLOUD_SNAP_RESTORE_FAILED"
	PX_GET_CLOUD_SNAP_STATUS_FAILED V1ErrorCode = "PX_GET_CLOUD_SNAP_STATUS_FAILED"
	PX_GET_VOLUME_FAILED V1ErrorCode = "PX_GET_VOLUME_FAILED"
	READ_DATA_SERVICE_MANIFEST_FAILED V1ErrorCode = "READ_DATA_SERVICE_MANIFEST_FAILED"
	UNMARSHAL_DATA_SERVICE_JSON V1ErrorCode = "UNMARSHAL_DATA_SERVICE_JSON"
	DEPLOYMENT_NAME_ALREADY_EXIST V1ErrorCode = "DEPLOYMENT_NAME_ALREADY_EXIST"
	TIMEOUT_BUSYBOX_POD_RUNNING V1ErrorCode = "TIMEOUT_BUSYBOX_POD_RUNNING"
	BUSYBOX_POD_FAILED V1ErrorCode = "BUSYBOX_POD_FAILED"
)
